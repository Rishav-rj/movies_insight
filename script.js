...
// Pick ramdon object from facts array
function movieFact(){
...
// Adding movie in Favourite list using localStorage
...
// Removing movie from Favourite list using localStorage
...
// Fetching data from the API using searchTerm parameter & creating movie cards for each movie
...
// calling movieList function on each key pressed & taking input value as a argument
if(searchBox != null){
...
// Fetching data from the API using ID & creating movie detail section
...
// Fetching movie details using ID stored in localstorage & creating cards for each movie
